...
class LinearFlow(FlowSpec):
    ...
    config = Parameter('config', help = "Name of profile configuration file", default = "regions_info.json")
    data_path = Parameter("data_path", help="dataframe path", default= "temp_data.csv" )
    ...
    def start(self):
        try:
            ...
            with open(r"/data2/naman/metaflow/input_file_path.json", 'r') as file:
            ...
            with open(r"/data2/naman/metaflow/sensor_data_weights.json", 'r') as file:
